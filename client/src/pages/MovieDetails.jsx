    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <motion.img 
          ...
          src={image_base_url+show.movie.poster_path} alt="" className='max-md:mx-auto
        ...
        <motion.div 
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 }}} className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="#dateSelect" className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull
            transition rounded-md font-medium cursor-pointer'>Buy Tickets</motion.a>
      ...
      <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once:true }} className='text-lg font-medium mt-20'>Your Favorite Cast</motion.p>
      <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
          <motion.div 
            ...
            {show.movie.casts.slice(0,12).map((cast,index)=>(
              <motion.div variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 }}} key={index} className='flex flex-col items-center text-center'>
      ...
      <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className='text-lg font-medium mt-20 mb-8'>You May Also Like</motion.p>
      <motion.div 
